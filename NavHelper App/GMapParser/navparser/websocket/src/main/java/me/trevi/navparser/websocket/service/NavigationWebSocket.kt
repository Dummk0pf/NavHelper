...
open class NavigationWebSocket : NavigationListener() {
    private lateinit var mServer1 : NettyApplicationEngine
    ...
    protected var socketPorts : IntArray
        ...
        set (value) {
            ...
            if (mSocketPorts.isEmpty())
                ...
                if (this::mServer1.isInitialized)
                    mServer1.stop(0, 0, TimeUnit.MILLISECONDS)
                tryRunServer()
            }
        }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (this::mServer1.isInitialized && !mServer1.application.isActive)
            mServer1.start()
    ...
    private fun setupServer(port: Int) {
        ...
        mServer1 = embeddedServer(Netty, port) {
            install(WebSockets) {
